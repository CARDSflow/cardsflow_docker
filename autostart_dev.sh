...
tmux new-session -s $session -d \; \
  ...
  send-keys -t 4 "sleep 5; source /opt/ros/foxy/setup.bash; source /roboy3/devel/setup.bash && ros2 launch kindyn robot.launch simulated:=true robot_name:=upper_body" C-m\; \
